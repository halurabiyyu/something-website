        ...
        <div class="d-flex justify-content-center align-items-center min-vh-100">
            <div class="bg-white p-4 rounded-3 shadow d-flex flex-column justify-content-center align-items-center" style="width: min(90%, 400px);">
                <div>
                    ...
                    <p class="fs-6 fw-light text-center text-secondary">Hi, Welcome to our something website</p>
                </div>
                @if (session('error'))
                ...
                @endif
                <div class="w-100">
                    <form action="{{route('register.store')}}" class="w-100" method="POST">
                        @csrf
                        <label for="name" class="fs-6">Name</label>
                        <input type="text" id="name" name="name" placeholder="John Lurs" class="form-control mb-3" required>
                        <label for="username" class="fs-6">Username</label>
                        <input type="text" id="username" name="username" placeholder="johnlurs123" class="form-control mb-3" required>
